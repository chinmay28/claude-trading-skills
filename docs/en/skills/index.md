...
| [Morning Advisor]({{ '/en/skills/morning-advisor/' | relative_url }}) | Run the daily pre-market trading routine — assess regime, manage open positions, generate 0–3 new long-call/long-put ... | <span class="badge badge-api">FMP Required</span> <span class="badge badge-api">Alpaca Required</span> |
