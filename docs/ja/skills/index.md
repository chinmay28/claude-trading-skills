...
| [Morning Advisor]({{ '/ja/skills/morning-advisor/' | relative_url }}) | Run the daily pre-market trading routine — assess regime, manage open positions, generate 0–3 new long-call/long-put ... | <span class="badge badge-api">FMP必須</span> <span class="badge badge-api">Alpaca必須</span> |
